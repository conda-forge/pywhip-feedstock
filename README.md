...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pywhip-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13097&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pywhip-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pywhip` can be installed with:

```
conda install pywhip
```

It is possible to list all of the versions of `pywhip` available on your platform with:
